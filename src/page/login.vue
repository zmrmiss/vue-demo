  ...
  <div class="page-login">
    ...
    <div class="login-panel">
      ...
      <div class="form">
        ...
        <el-input :class="{error:!userName && error}" v-model="userName" placeholder="手机号/用户名/邮箱" prefix-icon="profile"></el-input>
        <el-input :class="{error:!userName && password}" v-model="password" type="password" placeholder="密码" prefix-icon="password"></el-input>
        <div class="foot">
          <a href="#">忘记密码?</a>
        </div>
